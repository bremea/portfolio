<script>
	...
	export { outHeight as canvHeight };
	let outHeight = 550;
			...
			waitForCssVars() {
				if (
					...
					if (((this.cssVarRetries += 1), this.cssVarRetries > this.maxCssVarRetries))
						return (
							(this.sectionColors = [16711680, 16711680, 16711935, 65280, 255]), void this.init()
						);
...
<canvas
	style="--gradient-color-1:#4cc9f0;--gradient-color-2:#4361ee;--gradient-color-3:#3a0ca3;--gradient-color-4:#7209b7;"
	id="gradient-canvas"
	class="fixed -z-50"
	data-transition-in
/>
